package labschapter1609Geometry;

import javafx.scene.shape.Rectangle;

public class LabsChapter16092D extends GeometricObject {
    ...
    public LabsChapter16092D(double centerX, double centerY, double width, double height) {
    ...
    public LabsChapter16092D(MyPoint centerPoint, double width, double height) {
        this(centerPoint.x, centerPoint.y, width, height);
    }

    public LabsChapter16092D(Rectangle rectangle) {
        this(rectangle.getX(), rectangle.getY(), rectangle.getWidth(), rectangle.getHeight());
    }

    public LabsChapter16092D() {
        this(0, 0, 1, 1);
    }
    ...
    public boolean contains(LabsChapter16092D r2) {
    ...
    public boolean overlaps(LabsChapter16092D r2) {
    ...
    public static LabsChapter16092D getRectangle(double[][] points) {
    ...
    public static LabsChapter16092D getRectangle(MyPoint[] points) {
        ...
        return new LabsChapter16092D(centerX, centerY, width, height);
    }
