    ...
    public static void main(String[] args) throws Exception {
     ...
     //  String str2 = input.nextLine();
      ...
      //  }
        ...
        File sourceFile = new File("C:/Users/Wilfrido/Desktop/Java-2/LabsChapter1216b/src/labschapter1216b/score.txt");
        if(!sourceFile.exists()) {
            System.out.println("Source file " + sourceFile.getName() + " does not exist");
            System.exit(2);
        }
        //Check if target file exists
        File targetFile = new File("C:/Users/Wilfrido/Desktop/Java-2/LabsChapter1216b/src/labschapter1216b/score1.tx");
