...
public abstract class  LabsChapter1910GenericsWildcard <E extends Number> {
    // Abstract method for adding two elements of the matrices
    protected abstract E add(E o1, E o2);
    
    //Abstract method for multipying two elements of the matrices
    ...
    public E[][] multiplyMatrix(E[][] matrix1, E[][] matrix2) {
        ...
        //Perform multiplication two matrices
        for (int i = 0; i < result.length; i++) {
